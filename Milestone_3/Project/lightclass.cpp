...
void LightClass::SetPointLightColor(float red, float green, float blue, float alpha)
{
	m_PointLightColor = D3DXVECTOR4(red, green, blue, alpha);
	return;
}

void LightClass::SetPointLightPosition(float x, float y, float z)
{
	m_PointLightPosition = D3DXVECTOR4(x, y, z, 1.0f);
}

D3DXVECTOR4 LightClass::GetPointLightColor()
{
	return m_PointLightColor;
}

D3DXVECTOR4 LightClass::GetPointLightPosition()
{
...
void LightClass::GenerateProjectionMatrix(float screenDepth, float screenNear, float screenWidth, float screenHeight)
{
