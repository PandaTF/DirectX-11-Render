...
float GetDistance(float4 pos1, float4 pos2)
{
...
PixelInputType LightVertexShader(VertexInputType input)
{
    ...
    for (uint i = 0; i < 4; i++)
    {
        distance[i] = GetDistance(lightPosition[i], input.position);
    }

    output.PLParameter1 = float4(distance[0], 0.0f, 0.0f, 0.0f);
    output.PLParameter2 = float4(distance[1], 0.0f, 0.0f, 0.0f);
    output.PLParameter3 = float4(distance[2], 0.0f, 0.0f, 0.0f);
    output.PLParameter4 = float4(distance[3], 0.0f, 0.0f, 0.0f);
